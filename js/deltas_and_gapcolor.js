function deltas_and_gapcolor() {
    if (donnees.d != undefined && selected_idxjs >= 0) {
        ...
        for (var i in donnees.d) {
            ...
            if (disp_["delta"] == 1 || disp_gapcolors || (disp_["laps_deltas"] && laps_deltas_current)) {
                ...
                if (selected_idxjs in donnees.d) {
                    ...
                    if ((donnees.pro_v == 1 || donnees.try_v == 1) && (donnees.d[selected_idxjs].classid == donnees.d[i].classid || deltagraph_for_all == 1 || disp_gapcolors || (disp_["laps_deltas"] && laps_deltas_current))) {
                        ...
                        if ((deltax[i] != deltaxold[i])) {     // on ralentit l'actualisation du delta
                            ...
                            // REM : j'ai remis rc au lieu de rcf3 en Race le 01/09/2023 car sinon c'est pas correct notamment pour les laps_deltas
